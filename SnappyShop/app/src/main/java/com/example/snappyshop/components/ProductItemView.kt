    ...
    Card(
        ...
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Text(
                ...
                ), maxLines = 1, overflow = TextOverflow.Ellipsis, modifier = Modifier.padding(8.dp)
            )
            ...
            Row(
                ...
                Text(text = "$" + product.price, fontSize = 14.sp, textDecoration = TextDecoration.LineThrough)
                Spacer(modifier = Modifier.width(8.dp))
                Text(text = "$" + product.actualPrice, fontSize = 16.sp, fontWeight = FontWeight.SemiBold)
                Spacer(modifier = Modifier.weight(1f))
                IconButton(onClick = { AppUtil.addItemToCart(productId = product.id, context)}) {
                    Icon(
